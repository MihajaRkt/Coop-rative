INSERT INTO coop_chauffeurs (nom) VALUES
('Jean Dupont'),
('Amadou Diallo'),
('Pierre Koffi');

INSERT INTO coop_vehicules (nom) VALUES
('Toyota Hiace'),
('Mercedes Sprinter'),
('Nissan Caravan');

INSERT INTO coop_trajet (debut, fin, distance, idvehicule, idchauffeur, recetteMt, typee, carburantMt) VALUES
